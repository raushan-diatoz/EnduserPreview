...
public function gpsData(){
	if ( @fopen("http://www.google.com", "r") ) 
		{
   $xml1=simplexml_load_file("f") or die("Error: Cannot create object");
...
//For Home
	...
	{   
		...
		if(isset($_SESSION['email'])){
			$details=$this->User_model->user_details();       
			$xml=simplexml_load_file("/var/www/html/media/application/database/MediaBox.xml") or die("Error: Cannot create object");
			if(!empty($xml)){
