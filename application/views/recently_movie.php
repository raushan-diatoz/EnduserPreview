...
<body class="body">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card__content">
                    <h3 class="card__title"><a href="#"><?php echo $details_movie['title'];?></a></h3>
                    <span class="card__category">
                        <a href="#"><?php echo $details_movie['category'];?></a>
                    </span>
                    <span class="card__rate"><i class="icon ion-ios-star"><?php echo $details_movie['rate'];?></i></span>
    ...
    var source='';
    var store_time = '<?php echo $details_movie['time'];?>';
    var poster = '';
    </script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
         source = '<?php echo $details_movie['src'];?>';
        ...
        player.on('pause', event => {
            const instance = event.detail.plyr;
             ...
             poster = instance.media.poster;
             sessionStorage.setItem("time", store_time);
        });
    ...
    function recently_played() {
     ...
     data: {
                ...
                src: '<?php echo $details_movie['src'];?>',
                category: '<?php echo $details_movie['category'];?>',
                navbar:'<?php echo $details_movie['assetType'];?>',
                title: '<?php echo $details_movie['title'];?>',
                rate: '<?php echo $details_movie['rate'];?>',
                thumbnail: '<?php echo $details_movie['thumbnail'];?>',
                movie_id: '<?php echo $details_movie['movie_id'];?>'
            },
            dataType: 'json',
            success: function(response) {
              console.log('sucessfully store')
            }
