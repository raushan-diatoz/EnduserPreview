...
<body class="body">
	<!-- Sidebar -->
<div class="w3-sidebar w3-bar-block w3-animate-left" style="display:none;z-index:1000;top: 0;width: 300px;background: #1A1E21;" id="mySidebar">
  ...
  <div class="w3-overlay w3-animate-opacity" onclick="w3_close()" style="cursor:pointer;" id="myOverlay"></div>
	...
	<!-- filter -->
 <form method="post" action="<?php echo base_url();?>user/filter_movies">
	<div class="filter">
		<div class="container">
			<div class="row">
				<div class="col-12">
						...
						<div class="filter__items">
							...
							<div class="filter__item" id="filter__genre">
								...
								<div class="filter__item-btn dropdown-toggle" role="navigation" id="filter-genre" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									<input  value="All" name="genre"id="genre" style="width:85px;">
									<span></span>
								</div>
				...
				<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
					<div class="card">
						<div class="card__cover">
							...
							<img src="<?php echo $item->video->thumbnail;?>" alt="">
							<a href="details1.html" class="card__play">
