...
<body class="body">
		...
		<div class="container">
            ...
            <div class="col-12">
					...
					<div class="card">
						<div class="card__cover">
                            ...
                            <a onclick="document.getElementById('id01').style.display='block'"
                                        class="w3-button w3-black card__play" href="#">
				...
				<!-- end card -->
				  ...
				  <div id="wrapper">
                         <h3 style="color:yellow;">SORRY,NO Results WERE FOUND</h3>  
                        </div>
                   <?php
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/lightgallery/1.6.12/js/lightgallery-all.js"></script>
    ...
    PDFObject.embed("https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf#toolbar=0","#example2"); // When the user clicks anywhere outside of the modal, close it
