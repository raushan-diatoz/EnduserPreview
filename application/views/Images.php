...
<body class="body">
                    ...
                    <div class="filter__items">
                        ...
                        <div class="filter__item" id="filter__genre">
                            ...
                            <ul class="filter__item-menu dropdown-menu scrollbar-dropdown"
                                aria-labelledby="filter-genre" onclick="filter_images()">
                                <?php 
                                   if(!empty($media)){
  ...
  <section class="home">
                        ...
                        <div class="item" onclick="reply_click(<?php echo $img;?>)">
                            ...
                            <div class="card card--big">
                                <div class="card__cover">
                                    ...
                                    <img id="img<?php echo $img++;?>" src="<?php echo $movie->url;?>" alt="">
    ...
    function filter_images(){
      ...
      window.location=`<?php echo base_url();?>User/filter_images/${navbar}/${value}`;
