                    ...
                    <div class="filter__items">
                        ...
                        <div class="filter__item" id="filter__genre">
                            ...
                            <div class="filter__item-btn dropdown-toggle" role="navigation" id="filter-genre"
                                ...
                                <input value="Genre" name="genre" id="genre" style="width:85px;">
                                <span></span>
                            </div>

                            <ul class="filter__item-menu dropdown-menu scrollbar-dropdown"
                                aria-labelledby="filter-genre" onclick="filter_musics()">
                                <?php 
                                   if(!empty($media)){
                        ...
                        <div class="item">
                            ...
                            <div class="card card--big">
                                <div class="card__cover">
                                    ...
                                    <a id="pdf<?php echo $pdf;?>" onclick="pdf_data('<?php echo $pdf;?>')"  class="w3-button w3-black card__play" hreflang="https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf" >
                                        <i class="icon ion-ios-play"></i>
                                    </a>
                                </div>
                                <div class="card__content">
...
function reply_click(value) {
    ...
    function filter_musics(){
      var value = $("#genre").val();
      var navbar='<?php echo $navbar_name;?>';
      window.location=`<?php echo base_url();?>User/filter_musics/${navbar}/${value}`;
