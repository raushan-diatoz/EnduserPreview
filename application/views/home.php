...
<head>
    ...
    <!-- Favicons -->
    <link rel="icon" type="image/png" href="icon/digivive.png" sizes="32x32">
    <link rel="apple-touch-icon" href="icon/digivive.png">
...
<body class="body">
    ...
    <div class="w3-sidebar w3-bar-block w3-animate-left"
        ...
        <div style="padding: 0px 30px 30px 30px;">
            ...
            <div class="row side_nav">
                <div class="col-1">
                    <img src="icon/upcoming-stops.svg" />
                </div>
                <div class="col-8">
            ...
            <div class="row side_nav">
                <div class="col-1">
                    <img src="icon/privacy-policy.svg" />
                </div>
                <div class="col-8">
                    <a href="#" class="side_nav_menu">
                        Privacy Policy
            ...
            <div class="row side_nav">
                <div class="col-1">
                    <img src="icon/internet-access-1.svg" />
                </div>
                <div class="col-7">
                    <a href="#" class="side_nav_menu">
                        Internet Access
    ...
    <!-- start Upcoming stops -->
    <br><br><br><br>
    <?php
        if(!empty($upcoming)){
    ?>
    <div class="home">
        <div class="container upcoming_stops">
            <div class="row">
                <div class="col-md-3 col-md-6 
                lcol-sm-12 col-xs-12">
                    <p class="p-0 m-0 fleet__detail" style="color:white;font-size:12px">Arrival Time<span
                            STYLE="color:white;margin-left:146px;font-size:10px; width:auto"
                            class="ml-3"><?php echo $upcoming['time'];?></span></p>

                </div>
            </div>
            <div class="row">
                <span class="stops" style="padding-left: 15px;font-size:13px">Upcoming Stop</span><span
                    style="padding: 0px 15px;"><img style="width:87px;"
                        src="<?php echo base_url();?>icon/Arrow.svg"></span><span class="stops"
                    style="font-size:12px;"><?php echo $upcoming['stopName'];?></span>
            </div>
        </div>
    </div>
    <?php
        ...
        <div class="row">
            <div class="col-12">
                <?php 
					    ...
					    ?>
                <h1 class="home__title" id="title"><a id="title_anchor" href="#"><b>Recently Played</b></a>
                </h1>
                ...
                <div class="owl-carousel home__carousel">
                    ...
                    <div class="card card--big">
                        <div class="card__cover">
                            ...
                            <img src="<?php echo $item->thumbnail; ?>" alt="Avengers">
                            <a href="<?php echo base_url();?>user/recently_movie_play/<?php echo $item->current_time;?>/<?php echo $item->rate;?>/<?php echo $item->movie_id;?>"
                                class="card__play" >
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <h1 class="home__title" id="title"><a id="title_anchor"
                            href="<?php echo base_url();?>user/filter_media/<?php echo $item->Name;?>/<?php echo $navbar_name[$i];?>"><b><?php echo $genre_name; ?></b></a>
                    </h1>
                ...
                <div class="col-12">
                    <div id="crousel_<?php echo $count++;?>" class='owl-carousel'>
                        ...
                        foreach($item->Contents->Content as $movieDetails){
                        ...
                        <div class="item">
                            ...
                            <div class="card card--big">
                                <div class="card__cover">
                                    <img src="<?php echo $movieDetails->thumbnail;?>" alt="">
                                    <a href="<?php echo base_url();?>user/videos/<?php echo $navbar_name[$i];?>/<?php echo $genre_name; ?>/<?php echo $movieDetails->id;?>"
                                        class="card__play">
                                        <i class="icon ion-ios-play"></i>
                                    </a>
                                </div>
                                <div class="card__content">
                                    <h3 class="card__title"><a href="#"><?php echo $movieDetails->title;?></a></h3>
                                </div>
                            </div>
                        ...
                        <div class="item">
                            ...
                            <div class="card card--big">
                                <div class="card__cover">
                                    <img src="<?php echo $movieDetails->thumbnail;?>" alt="">
                                    <a href="<?php echo base_url();?>user/play_music/<?php echo     $navbar_name[$i];?>/<?php echo $genre_name; ?>/<?php echo $movieDetails->id;?>"
                                        class="card__play">
                                        <i class="icon ion-ios-play"></i>
                                    </a>
                                </div>
                        ...
                        <div class="item" onclick="reply_click(<?php echo $img;?>)">
                            ...
                            <div class="card card--big">
                                <div class="card__cover">
                                    ...
                                    <img id="img<?php echo $img++;?>" src="<?php echo $movieDetails->url;?>" alt="">
                        ...
                        <div class="item">
                            ...
                            <div class="card card--big">
                                <div class="card__cover">
                                    ...
                                    <a class="card__play" href="<?php echo $movieDetails->url;?>">
                                        <i class="icon ion-ios-play"></i>
                                    </a>
                                </div>
                                <div class="card__content">
                        ...
                        <div class="item">
                            ...
                            <div class="card card--big">
                                <div class="card__cover">
                                    ...
                                    <a id="pdf<?php echo $pdf;?>" onclick="pdf_data('<?php echo $pdf;?>')"
                                        class="w3-button w3-black card__play"
                                        hreflang="https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf">
                                        <i class="icon ion-ios-play"></i>
                                    </a>
                                </div>
                                <div class="card__content">
    ...
    <footer class="footer  text-center">
        <div class="row " id="myDIV">
            ...
            <div class="col-2">
                ...
                <a href="<?php echo base_url()?>user"><button class="btn active_1"><img style="width:33px;"
    ...
    <script>
    function view_video(movie_id,title,category,navbar) {
    ...
    function pdf_data(i) {
        ...
        PDFObject.embed(path + '#toolbar=0',
        "#example2"); // When the user clicks anywhere outside of the modal, close it
