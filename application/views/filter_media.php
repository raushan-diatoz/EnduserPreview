        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <h1 class="home__title"><b><?php echo $filter->Name;?></b></h1>
                </div><br><br>
                <!-- card -->
                <?php 
						if(isset($filter)){
				...
				?>
                <?php
                        foreach($filter->Contents->Content as $item){
                ...
                <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                    ...
                    <div class="card">
                        <div class="card__cover">
                            ...
                            <a href="<?php echo base_url();?>user/videos/<?php echo $navbar_name;?>/<?php echo $genre_name; ?>/<?php echo $item->id;?>"
                                class="card__play">
                                <i class="icon ion-ios-play"></i>
                            </a>
                        </div>
                        <div class="card__content">
                            <h3 class="card__title"><a href="#"><?php echo $item->rating; ?></a></h3>
                ...
                <div class="card card--big">
                    <div class="card__cover">
                        ...
                        <a id="pdf<?php echo $pdf;?>" onclick="pdf_data('<?php echo $pdf;?>')"  class="w3-button w3-black card__play" hreflang="<?php echo $item->url;?>" >
                            <i class="icon ion-ios-play"></i>
                        </a>
                    </div>
