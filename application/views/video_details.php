...
<body class="body">
    ...
    <section class="home">
       ...
       ?>  
        <div class="container">
            <div class="wrapper masthead-1">

                <div class="poster">
                    <img id="pos" class="pos" src="<?php echo $data_filter->thumbnail;?>">
                </div>
                <div class="poster-blur"></div>
                <div class="colour"></div>

                <div class="content">
                    <h1 class="movie_title"><?php echo $data_filter->title;?></h1>
                    <p class="meta">
                        <?php echo $data_filter->duration;?>min &#8226; <?php echo $data_filter->year;?> &#8226;
                        <?php echo $data_filter->genre;?> &#8226;
                        <?php echo $data_filter->rating;?> &#8226; <?php echo $data_filter->language;?>
                    </p>
                    <p class="description">
                        <?php echo $data_filter->summary;?>
                    </p>
                    <div class="watch_now" style="padding-top: 100px;" >
                        <a
                            href="<?php echo base_url();?>user/play/<?php echo $category;?>/<?php echo $assetType;?>/<?php echo $data_filter->id;?>"><i
                                class="icon ion-ios-play"></i>&nbsp; Watch Now</a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <h1 class="home__title" id="title"><a id="title_anchor"
                            href="<?php echo base_url();?>user/filter_media/<?php echo $category;?>/<?php echo $assetType;?>"><b>Suggestion Videos</b></a>
                    </h1>
                        ...
                        <div class="item">
                            ...
                            <div class="card card--big">
                                <div class="card__cover">
                                    <img src="<?php echo $details->thumbnail;?>" alt="">
                                    <a href="<?php echo base_url();?>user/videos/<?php echo $assetType;?>/<?php echo $category; ?>/<?php echo $details->id;?>" class="card__play">
                                        <i class="icon ion-ios-play"></i>
                                    </a>
                                </div>
                                <div class="card__content">
                                    <h3 class="card__title"><a href="#"><?php echo $details->title;?></a></h3>
                                    <span class="card__category">
                                        <a href="#"><?php echo $details->genre;?></a>
                                    </span>
                                    <span class="card__rate"><i class="icon ion-ios-star"></i><?php echo $details->rating;?></span>
                                </div>
                            </div>
                            <!-- end card -->
                        </div>
    ...
    function view_video(){
      ...
      $.ajax({
          url: '<?php echo base_url();?>User/view_movie',
          method: 'post',
          data: {
              movie_id: '<?php echo $data_filter->id;?>',
              assetType: '<?php echo $category;?>',
              category:  '<?php echo $assetType;?>',
              mediaName:  '<?php echo $data_filter->title;?>'
          },
          dataType: 'json',
          success: function(response) {
            console.log('video store inside database')
          }
...
<script>
    var path = $('#pos').attr('src');
    var url = "url(" + path + ")";
    $(".poster, .poster-blur").css("background-image", url);
    </script>
    <script>
  function allMovies(){
