				...
				<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
					<div class="card">
						<div class="card__cover">
							...
							<a href="<?php echo base_url();?>user/genre_videos/<?php echo $navbar_name;?>/<?php echo $item->id;?>" class="card__play">
								<i class="icon ion-ios-play"></i>
							</a>
						</div>
						<div class="card__content">
							<h3 class="card__title"><a href="details1.html"><?php echo $item->title; ?></a></h3>
